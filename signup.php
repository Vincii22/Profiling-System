        ...
        <div id="sidelogin">
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    <form enctype="multipart/form-data" action="signup_query.php" role="form" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" name="confirm_pass" placeholder="Confirm Password" type="password" required="required">
                        </div>
                        <div class="form-group">
                            <button class="btn btn-block btn-custom" name="signup"><span class="glyphicon glyphicon-user"></span> Sign Up</button>
                        </div>
                    </form>
                </div>
            </div>    
